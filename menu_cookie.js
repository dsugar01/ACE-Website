...
if (get_cookie(window.location.pathname) != ''){
  ...
  for (i=0 ; i < openresults.length ; i++){
    ...
    foldercontentarray[openresults[i]].previousSibling.previousSibling.style.listStyleImage="url(images/minus.png)"
    }
    else{
    foldinglist[openresults[i]].style.display=''
    document.all[foldinglist[openresults[i]].sourceIndex -1].style.listStyleImage="url(images/minus.png)"
    }
  }
}
