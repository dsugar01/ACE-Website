...
<div id="contentleft">
	...
	<div id="equipmentlistheader">
		<span class="ace">ace </span><span class="headertext">Equipment</span><span class="headerendtext">systems</span>
	</div>
...
<div id="contentright">
	...
	<div id="datasheetsheader">
		<span class="header2">Data Sheets</span>
	</div>
	...
	<div id="datasheetscontainer">
		...
		<a href="" class="credittext" target="new">Z_head_alt_config.pdf</a> -->
        <?php
	...
	<div id="creditsheader">
		<span class="header2">Credits</span>
	</div>
	...
	<div id="creditscontainer">
			...
			for($i = 0; $i < $num; $i++) {
				...
				if ($count > 0) {		
					print("<a class='credittext' href='credits.php?credit=$cr_id'>$name</a><br />");
					}
