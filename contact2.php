...
$email_to = "acecontacts1@gmail.com";
$email_subject = "New Contact Information";
...
$email_message = "Form details below.\n\n";
   ...
   $port = "465";
   $username = "acecontacts1@gmail.com";
   $password = "alicedog1";
  ...
  /*$headers = 'From: '.$email_from."\r\n".
   ...
   $query = "INSERT into contacts (id, firstName, lastName, email, phone, comments) values ('$id','$first_name','$last_name','$email_from','$phone','$comments')";
   echo $query;
   mysql_query($query);
   
   print("<p class='instructions'>Thank you for taking the time to contact us.</p>");
}
?>
