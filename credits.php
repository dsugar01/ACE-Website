...
<table>
<tr>
<th><span class='credittext'>Feature Films</span></th>
<th><span class='credittext'>Television</span></th>
<th><span class='credittext'>Commercials</span></th>
<th><span class='credittext'>Sports</span></th>
</tr>
<tr>
...
<?php 
	...
	die();
		...
		$sql_string = "SELECT * FROM ace_credits
					WHERE cr_category = 'Feature Films'
	...
	if ($num == 0) {
		...
		echo "<p class='credittext'>Credits coming soon!</p>";
		return;
	}
