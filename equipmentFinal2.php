...
<div id="tophalfwrapper">
		<div id="logo">
			<a href="index.html"><img src="images/acelogo.png" border="0" alt="ACE East"></a>		</div>
...
<div id="slideshow" class="horinaja">
			...
			<ul style="left:0px">
			<li>
				<img width="1009" src="../header/staticheader_1.jpg"><img src="images/redcircle2.png" class="above1">
			...
			<li>
				<img width="1009" src="../header/staticheader_2.jpg"><img src="images/redcircle2.png" class="above2">
			...
			<li>
				<img width="1009" src="../header/staticheader_3.jpg"><img src="images/redcircle2.png" class="above3">
			...
			<li>
				<img width="1009" src="../header/staticheader_4.jpg"><img src="images/redcircle2.png" class="above4">
			...
			<li>
				<img width="1009" src="../header/staticheader_5.jpg"><img src="images/redcircle2.png" class="above5">
			...
			<li>
				<img width="1009" src="../header/staticheader_05.jpg"><img src="images/redcircle2.png" class="above6">
			...
			<li>
				<img width="1009" src="../header/staticheader_6.jpg"><img src="images/redcircle2.png" class="above7">
			...
			<li>
				<img width="1009" src="../header/staticheader_7.jpg"><img src="images/redcircle2.png" class="above8">
			...
			<li>
				<img width="1009" src="../header/staticheader_8.jpg"><img src="images/redcircle2.png" class="above9">
			...
			<li>
				<img width="1009" src="../header/staticheader_9.jpg"><img src="images/redcircle2.png" class="above10">
...
//					print("<div class='equipmentlist_subgroup1'>");
					print("<div id='$row_system[subitem]'>");
						print("<div class='equipmentbuttonpadding'>");
					print("<span class='equipmentlist_text2'><a class='equipmentlist_text2' href='equipment.php?system=$row_system[cs_id]'>$row_system[cs_name] </a> </span>");
					print("</div>");
					print("</div>");
...
<div id="contentright">
        ...
        <?php
		if($system == 'firstload'){
		print("<div id='systemdetailsheader'><span class='ace'>Equipment</span></div>");
		print("<div id='systemdetailscontainer'>");
		print("<div id='descriptioncontainer'>");
		print("<p class='descriptiontext'>Welcome to Atlantic Cine Equipment, Inc., the largest supplier of Remote and Robotic equipment for feature films, network television, and commercials in the east, and a quickly growing force in the west. We rent the full Nettmann line of remote heads and specialized systems including the NEW Stab-C Compact 2.0, the most state of the art, powerful, fully stabilized 5 axis remote head on the market, SuperTower20 & 6, as well as award winning TrackRunner. Our new ACE MicroMote HD systems are one of a kind. They feature on air moves, and a custom PC paint program that can be operated from 6000' over a twisted pair, same as pan, tilt, zoom, focus, and iris. Here is where you will find the specialized equipment that will fit your, next production.</p>"); 
		print("</div>");
		$latestSystemsImages = "SELECT im_image, im_caption from ace_images ORDER BY RAND() LIMIT 5";
		$latestSystemsImagesResult = mysql_query($latestSystemsImages);
		print("<div id='datasheetsheader'>");
		print("<span class='header2'>See Our Latest Systems</span></div>");
		print("<div id='video'>");
		print("<ul class='bxslider'>");
		while($rowImages = mysql_fetch_array($latestSystemsImagesResult)){
		...
		print("<span class='ace'>ace </span><span class='headertext'>$row_title[cs_name]</span><span class='headerendtext'>camera system</span>");
		}
		?>
...
<div id="contactheader">
	...
	<div id="contacts">
		<table id="officenumbers">
			...
			<tr>
				<td id="losangelas">
			<span class="conlocation">Los Angelas</span><span class="phonenumb">(818)-794-9410</span>				</td>
			</tr>
			<tr>
				<td id="fax">
