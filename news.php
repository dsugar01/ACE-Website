...
if(! (mysql_connect("mysql-aceeast324581.aceeast.comcastbiz.net", "aceeast324581", "AceIsC00l") && mysql_select_db("aceeast324581"))){
	...
	$query = "SELECT * from ace_news where id=$id";
	$result = mysql_query($query);	
	$row=mysql_fetch_array($result);
	print("<p style='color: #ffffff'>$row[title]</p>");
	print("<hr>");
	print("<img class='article' src='$row[image]' height='300'>");
	print("<p class='newstext2'>$row[articleText]</p>");
}
?>
</div>
